...
export const zh = {
  ...
  admin: {
    ...
    relationName: '姓名 *',
    relationType: '关系类型',
    relationImportance: '重要度',
    relationAvatar: '头像 URL',
    relationDescription: '描述',
    relationLinks: '关联人物',
    relationStories: '共同经历',
    relationStoryDate: '日期',
    relationStoryEvent: '经历',
    relationAddPerson: '+ 添加人物',
    relationDeletePerson: '删除人物',
    relationDeleteConfirm: '确定删除「{title}」？此操作不可撤销。',
    relationAddStory: '+ 添加经历',
    relationSave: '保存图谱',
    relationSaved: (path: string) => `图谱已保存: ${path}`,
    relationSelectHint: '← 从左侧选择人物开始编辑，或点击「+ 添加人物」',
    relationEmpty: '还没有人物，点击「+ 添加人物」创建第一个吧',
    relationNameRequired: '请填写姓名',
    // 图片上传
    imageUpload: '📷 上传图片',
    ...
    consumptionGroupMovie: '🎬 影视（电影 / 剧集 / 动漫）',
    consumptionGroupBook: '📚 书籍 / 小说',
    consumptionSearchPlaceholder: '输入标题，自动检索元数据...',
    consumptionSearching: '正在搜索元数据...',
    consumptionUnrated: '未评分',
    consumptionToday: '今天',
    consumptionDateInvalid: '日期格式无效（YYYY、YYYY-MM 或 YYYY-MM-DD）',
    consumptionYearInvalid: '年份需为 1900-2100 的整数',
    consumptionStartDate: '开始日期',
    consumptionWorkInfo: '作品信息（自动带出）',
    consumptionMyRecord: '我的记录',
    consumptionSourceInfo: '来源信息（自动填充）',
    consumptionSourceManual: '手动',
